*********************************************************************************
* Origine du fichier l:\up\tp3\ex1\asm_ps3.asm  (rev. 30-01-2004)		*
...
*   		Fonction asm_ps3() en assembleur 
*		^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^	
...
*
* Exemple d'appel : y= asm_ps3(a, x, 256);
...
* POUR CE PROGRAMME :
* ^^^^^^^^^^^^^^^^^^^
* PROGRAMMATION EN ASSEMBLEUR EN UTILISANT LE SOFTWARE PIPELINING AVEC ÉPILOGUE.
